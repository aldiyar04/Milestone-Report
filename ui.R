...
shinyUI(   fluidPage(
  ...
  mainPanel(
    ...
    wellPanel(
      h4("Details"),
      HTML("<p> Github Repository <a href='https://github.com/aldiyar04/Milestone-Report' target='_blank'>https://github.com/aldiyar04/Milestone-Report</a></p>"),
